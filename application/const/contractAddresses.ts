const address = (name: string, value: string | undefined, fallback: string): string => {
...
export const CHARACTER_EDITION_ADDRESS = address(
  ...
  process.env.NEXT_PUBLIC_CHARACTER_EDITION_ADDRESS,
...
export const GOLD_GEMS_ADDRESS = address(
  ...
  process.env.NEXT_PUBLIC_GOLD_GEMS_ADDRESS,
...
export const PICKAXE_EDITION_ADDRESS = address(
  ...
  process.env.NEXT_PUBLIC_PICKAXE_EDITION_ADDRESS,
